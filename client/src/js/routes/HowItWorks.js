			...
			<Fragment>
				...
				<article>
					<section className="page-section page-section--center horizontal-padding">
						<div style={{width: "90%", height:"auto", border:"20px", display:"flex", gap:"2", flexDirection: "column", alignItems:"center", justifyContent:"center"}}>
								<h1 style={{marginBottom: "0px", fontSize:25}} >Fundraising on JustCause takes just a few minutes </h1>
								<h2 style={{fontSize:17}} >Create and fund pools with your friends and JustCause smart contracts donate crypto while preserving your initial deposit</h2>
								<MaleOne/>
						</div>
					</section>
