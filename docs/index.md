...
Verified pools are created by the team, and the recipient of the funds are known and established entities.  The recipients of the funds are public and doxxed. In short, any user who contributes knows where the donations are going.  
  
### User Pools
  
User pools are generated by pool creators utilizing the protocol’s smart contracts. The recipients of the funds are specified by the creators at the time of generation. It is important to note that anyone can create a pool for any reason. More importantly, the allocation of funds cannot be accounted for in most circumstances. Therefore, it is crucial that users take caution when contributing to such Causes. We advise only contributing to user pools if you know and trust both the pool creator and receiver. 
</div>
