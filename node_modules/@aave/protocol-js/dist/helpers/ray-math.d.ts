...
export declare function wadMul(a: BigNumberValue, b: BigNumberValue): BigNumber;
export declare function wadDiv(a: BigNumberValue, b: BigNumberValue): BigNumber;
...
export declare function rayToDecimal(a: BigNumberValue): BigNumber;
