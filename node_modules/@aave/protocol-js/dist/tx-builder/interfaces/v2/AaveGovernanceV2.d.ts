...
import { GovCreateType, GovCancelType, GovQueueType, GovExecuteType, GovSubmitVoteType, GovSubmitVoteSignType, GovSignVotingType, GovGetProposalsType, GovGetProposalType, GovGetVotingAtBlockType, GovGetVotingSupplyType, GovGetTokensVotingPower as GovGetPower, GovGetVoteOnProposal } from '../../types/GovernanceV2MethodTypes';
...
export default interface AaveGovernanceV2Interface {
    ...
    submitVote: (args: GovSubmitVoteType) => Promise<EthereumTransactionTypeExtended[]>;
    submitVoteBySignature: (args: GovSubmitVoteSignType) => Promise<EthereumTransactionTypeExtended[]>;
    ...
    getTotalPropositionSupplyAt: (args: GovGetVotingSupplyType) => Promise<string>;
